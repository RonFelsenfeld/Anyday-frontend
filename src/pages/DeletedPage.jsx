...
export function DeletedPage() {
    ...
    return (
        <div className="img-container-trash">
            <img src="/assets/img/empty_state_deleted_3.svg" alt="garbage"
                className="trash-img" />
            <div className="second-section flex column align-center">
                ...
                <Link to='/board' /> <button className="back-to-main">Back to workspace</button><Link />
            </div>
        </div>
    )
}