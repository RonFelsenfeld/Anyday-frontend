      ...
      {activity.action === 'Priority' && (
        <>
          ...
          <div
            ...
            className="from flex align-center justify-center"
          >
            {activity.from?.title}
          </div>
          <ArrowRight />
          <div
            ...
            className="to flex align-center justify-center"
          >
            {activity.to?.title}
          </div>
        </>
      ...
      {activity.action === 'Timeline' && (
        <React.Fragment>
          ...
          <div
            ...
            className="timeline-action flex align-center justify-center"
          >
            {activity.oldTimeLine
              ? utilService.getFormattedTimeline(
                  activity.oldTimeLine?.startDate,
                  activity.oldTimeLine?.dueDate
                )
              : '-'}
          </div>
          <ArrowRight />
          ...
          >
            {utilService.getFormattedTimeline(
              activity.newTimeLine?.startDate,
              activity.newTimeLine?.dueDate
            )}
          </div>
        </React.Fragment>
      )}
