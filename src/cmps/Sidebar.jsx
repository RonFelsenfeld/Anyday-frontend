...
import { Home, MiniBoard, MiniHome, MyWork, SidebarArrow, WorkSpaceOption } from '../services/svg.service'
                        ...
                        <ul className='side-bar-boards-list clean-list'>
                            {
                                boards.map(board =>
                                    <div className=''>
                                        <NavLink className="navlink" to={`/board/${board._id}`}>
                                            <li className='board-li flex align-center' key={board._id}>
                                                <MiniBoard />
